...
<head>
    ...
    <title>Ficha de Matrícula - {{ $matricula->estudiante->codigo_estudiante }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <span>{{ $matricula->estudiante->codigo_estudiante }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">DNI:</span>
                    <span>{{ $matricula->estudiante->dni }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Apellidos:</span>
                    <span>{{ $matricula->estudiante->apellido_paterno }} {{ $matricula->estudiante->apellido_materno }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Nombres:</span>
                    <span>{{ $matricula->estudiante->nombres }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Programa:</span>
                    <span>{{ $matricula->estudiante->programaEstudio->nombre }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Plan:</span>
                    <span>{{ $matricula->estudiante->planEstudio->nombre }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Turno:</span>
                    <span>{{ $matricula->estudiante->turno->nombre }}</span>
                </div>
                <div class="info-item">
        ...
        <div class="section">
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span>{{ ucfirst($matricula->tipo) }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Estado:</span>
                    <span>{{ ucfirst($matricula->estado) }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="no-print" style="margin-top: 30px; text-align: center;">
            ...
            <a href="{{ route('admin.matriculas.index') }}" style="margin-left: 10px; padding: 10px 20px; background: #666; color: white; text-decoration: none; border-radius: 5px;">
                Volver
            </a>
        </div>
    </div>
